...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        FFRoute(
          ...
          path: '/',
          builder: (context, _) =>
              appStateNotifier.loggedIn ? NavBarPage() : CreateAccountScreenWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: RecordScreenWidget.routeName,
          path: RecordScreenWidget.routePath,
          builder: (context, params) => const RecordScreenWidget(),
        ),
        FFRoute(
          name: ToDoListScreen1Widget.routeName,
          path: ToDoListScreen1Widget.routePath,
          builder: (context, params) => ToDoListScreen1Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'notesScreen')
              : NotesScreenWidget(),
        ),
        FFRoute(
          name: NewNoteScreenWidget.routeName,
          path: NewNoteScreenWidget.routePath,
          builder: (context, params) => NewNoteScreenWidget(),
        )
